...
{   
	...
	VideoCapture capLeft("/home/kroad/parking_video/sample.mp4");
    VideoCapture capRight("/home/kroad/parking_video/sample.mp4");
    ...
    while (ros::ok()) 
    {
		...
		if((mission_flag == 10)||(mission_flag == 6))
		{
			...
			{	
				...
				leftMask = stereovision.adaptiveThreshold_parking(leftFrame);
				rightMask = stereovision.adaptiveThreshold_parking(rightFrame);
