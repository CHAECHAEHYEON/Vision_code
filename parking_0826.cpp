...
{   
    ...
    VideoCapture capLeft(left_cam_index); //9
    VideoCapture capRight(right_cam_index); //1
    ...
    while (ros::ok()) 
    {
        ...
        else
		{
            ...
            if((parking_level_1 == false) && (parking_level_2 == false) && (parking_level_3 == false) && (FinalLevel == false))
            {
                cout << " Wating Lidar Stop" << endl;
				imshow("Left_mask", leftMask);
           		imshow("Right_mask", rightMask);
            }
            else if((parking_level_1 == true) && (parking_level_2 == false) && (parking_level_3 == false) && (FinalLevel == false))
            {	
				encoder = 2;
				imshow("Left_mask", leftMask);
           		imshow("Right_mask", rightMask);
            ...
            else if((parking_level_1 == true) && (parking_level_2 == true) && (parking_level_3 == true) && (FinalLevel == false))
            {
				encoder = 2;
			...
			else if((parking_level_1 == true) && (parking_level_2 == true) && (parking_level_3 == true) && (FinalLevel == true))
			{
				encoder = 1;
				cout << " Finish !!! " << endl;
			}
