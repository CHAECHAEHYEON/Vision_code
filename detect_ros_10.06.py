...
class Yolov7Publisher:
    def __init__(self, img_topic: str, weights: str, conf_thresh: float = 0.5,
                 ...
                 device: str = "cuda", flag_pub_topic: str = "flag_pub", detect_length_pub_topic: str = "detect_length",
        ...
        self.detection_publisher = rospy.Publisher(
            pub_topic, Detection2DArray, queue_size=10
        )
        self.flag_publisher = rospy.Publisher(
            flag_pub_topic , Bool, queue_size=1
        )
        self.detect_length_publisher = rospy.Publisher(
            detect_length_pub_topic, Int16, queue_size= 20
        )
