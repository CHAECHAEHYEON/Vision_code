...
class Yolov7Publisher:
    def __init__(self, img_topic: str, weights: str, conf_thresh: float = 0.5,
                 ...
                 device: str = "cuda", flag_pub_topic: str = "flag_pub",
...
def callbackfunction(msg):
    global pub_flag
    pub_flag= msg.data
    rospy.loginfo(pub_flag)

def YoloV7Subscriber():
    rospy.Subscriber("/yolov7/pub_flag", Bool, callbackfunction)
